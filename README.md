...
- **提分密训**：[2026.09] 乐橙网 5 套（法规密训×2 / 金融密训 / 金融模拟密卷 / 金融章节母题）共 646 题，含逐题解析
...
- **证券学习系统题库**：整理自开源仓库 [zfabc/zhengquantest](https://github.com/zfabc/zhengquantest)（2019-2024 真题回忆版 + 章节练习）、[kawu98661-cell/card-batch-demo](https://github.com/kawu98661-cell/card-batch-demo)（章节分类补充题库）、公开流通的备考教材讲义 PDF 、[2026.09] LC 终极押题与乐橙网提分密训/章节母题/模拟卷（考前辅导材料，仅供内部学习）；官方信息以[中国证券业协会](https://www.sac.net.cn/)为准。
